                ...
                try {
                    ...
                    setTimeout(() => {
                        try {
                            ...
                            console.error(`Failed to close ${windowName} after focus:`, e);
                        }
                    }, 100);
                } catch (e) {
                    console.error(`Failed to focus ${windowName}:`, e);
                }
            }
        }
...
'''
        ...
        function openDeepL() {
            ...
            if (sourceLang === 'zh') {
                url = `https://www.deepl.com/en/translator#zh/en-gb/${encodeURIComponent(text)}`;
            } else {
                url = `https://www.deepl.com/en/translator#en/zh-hans/${encodeURIComponent(text)}`;
            }
